//! A small interpreter for the Achuk expression core.
//!
...
//! achuk-contract so contract predicates and program results speak the same
//! language.
...
fn is_builtin(name: &str) -> bool {
    matches!(
        ...
        "Nat.add"
            ...
            | "List.len"
            | "Bool.if"
            // Operator/method names the compiler lowers to (real .achuk bodies).
            | "plus"
            | "minus"
            | "times"
            | "is_lt"
